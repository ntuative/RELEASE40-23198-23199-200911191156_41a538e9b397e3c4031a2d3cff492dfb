package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_465 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      {
         return !true ? var_140[param1] as FZipFile : null;
      }
      ...
      {
         if(var_465.parse(param1))
         {
            var_52.push(var_465);
            if(false)
            {
               var_140["null"] = var_465;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1091,var_465));
            var_465 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_52 != null && var_140 != null && param1 < var_52.length)
         {
            _loc2_ = var_52[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_52.splice(param1,1);
               delete var_140[_loc2_.filename];
               return _loc2_;
            }
         }
         return null;
