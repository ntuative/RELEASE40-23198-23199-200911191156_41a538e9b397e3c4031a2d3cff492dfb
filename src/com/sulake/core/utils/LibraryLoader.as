package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1336:uint = 2;
      
      protected static const const_1335:uint = 1;
      
      protected static const const_1536:int = 5;
      
      protected static const const_1035:uint = 7;
      
      protected static const const_1337:uint = 4;
      
      protected static const const_1338:uint = 3;
       
      
      protected var var_1030:int;
      ...
      protected var var_332:Class;
      
      protected var var_2243:uint = 0;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_332 = this.getDefinition(_name) as Class;
         if(var_332 == null)
         {
         ...
         try
         {
            xmlClass = var_332.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_461 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               debug("Load event STATUS " + var_348 + " for file \"" + var_1.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
         ...
         if(var_411 == LibraryLoader.const_1338)
         {
            if(analyzeLibrary())
            {
               var_411 |= 0;
         ...
         if(var_411 == LibraryLoader.const_1035)
         {
            var_1284 = true;
            prepareLibrary();
            removeEventListeners();
