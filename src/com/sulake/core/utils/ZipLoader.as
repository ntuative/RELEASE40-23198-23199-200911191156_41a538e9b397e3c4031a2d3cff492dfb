package com.sulake.core.utils
{
   ...
   public class ZipLoader extends LibraryLoader
   {
      ...
      private var var_555:FZip;
      
      private var var_1217:Array;
      
      private var var_1979:uint = 0;
      ...
      private function onLoaderComplete(param1:Event) : void
      {
         ...
         var_1217.push(var_1.contentLoaderInfo.applicationDomain.getDefinition(_loc3_));
         ++var_800;
         if(var_1217.length == var_1979)
         {
         ...
         {
            var_1.loadBytes(var_555.getFileAt(var_800).content);
         }
      }
      ...
      override public function load(param1:URLRequest, param2:LoaderContext = null, param3:int = 1) : void
      {
         var_347 = param1;
         var_555 = new FZip();
         var_555.addEventListener(Event.COMPLETE,onComplete);
         var_555.addEventListener(IOErrorEvent.IO_ERROR,onIOError);
         var_555.addEventListener(ProgressEvent.PROGRESS,onProgress);
         var_555.load(var_347);
      }
