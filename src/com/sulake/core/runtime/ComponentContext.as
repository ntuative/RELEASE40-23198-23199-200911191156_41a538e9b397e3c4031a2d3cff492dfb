   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,CoreComponent.const_1246);
            }
      ...
      public final function loadFromFile(param1:URLRequest, param2:LoaderContext) : LibraryLoader
      {
         ...
         var _loc4_:LibraryLoader = new LibraryLoader(var_850);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            if(var_344 != null)
            {
               ...
               while(_loc1_-- > 0)
               {
                  IDisposable(var_344.pop()).dispose();
               }
               var_344 = null;
            }
            if(var_236 != null)
      ...
      protected final function hasQueueForInterface(param1:IID) : Boolean
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(getQualifiedClassName(var_344[_loc4_].identifier) == _loc2_)
            {
               return true;
            }
            _loc4_++;
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,CoreComponent.const_1193);
      }
         ...
         while(_loc18_ < _loc5_.length())
         {
            ...
            if(_loc24_ > 0)
            {
               ...
               while(_loc26_ < _loc24_)
               {
                  ...
                  {
                     error("Manifest for component " + _loc7_ + " contains broken asset \"" + _loc21_ + "\"!",true,CoreComponent.const_554);
                  }
                  _loc26_++;
               }
            }
            ...
            if(_loc6_ == null)
            {
               error("Invalid component class " + _loc7_ + "!",true,CoreComponent.const_554);
               return false;
            }
            ...
            if(_loc4_ != null)
            {
               if(_loc25_ != null)
               {
                  ...
                  {
                     _loc25_.dispose();
                     error("Component \"" + _loc7_ + "\" did not save provided asset library!",true,CoreComponent.const_554);
                  }
               }
