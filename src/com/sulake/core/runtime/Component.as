package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1249:uint = 4;
      ...
      protected var var_358:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_1706:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_849 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_849);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1029 & const_1249)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_358 + "]";
      }
   }
}
