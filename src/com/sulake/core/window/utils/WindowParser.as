package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1463:String = "_INCLUDE";
      
      public static const const_981:String = "_EXCLUDE";
      
      public static const const_1436:String = "_TEMP";
      
      private static const const_1079:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1078:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1286:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(var_861,var_1286);
         var_1287 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1078,"");
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1286)
            {
               delete var_1286[_loc1_];
            }
            var_1287.dispose();
            var_1287 = null;
            _context = null;
