package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      protected var var_570:Function;
      
      protected var _children:ChildEntityArray;
      
      protected var var_850:Boolean;
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_116,WindowParam.const_131);
         ...
         if(_loc1_ || _loc2_)
         {
            ...
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_273)
               {
                  _loc3_.x += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_362)
         {
            return true;
         }
         _state = WindowState.const_362;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1614 + "]";
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_22,WindowRedrawFlag.const_775);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_879 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_313,this,param1));
         return param1;
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_709))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_910;
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_257:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_150,WindowParam.const_131))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_157,WindowParam.const_133))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_363))
                        {
                           var_23.height += 0 - 0;
                        }
                        var_31 = _loc8_;
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_267,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_453:
                  _context.invalidate(this,var_22.union(var_59),WindowRedrawFlag.const_349);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_765,this,null));
                     if(var_23 != null)
                     {
               ...
               case WindowNotifyEvent.const_308:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_597,this,null));
                     if(var_23 != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_382:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_786);
                  break;
               case WindowNotifyEvent.const_419:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_413:
                  if(!(var_31 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_349);
                     }
                  }
                  else if(var_31 & 0)
                  {
               ...
               case WindowNotifyEvent.const_208:
                  ...
                  break;
               case WindowNotifyEvent.const_421:
                  var_23.getRegionProperties(null,var_278);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_313:
      ...
      {
         return var_570 != null ? var_570 : (var_23 != null ? var_23.procedure : nullEventProc);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_491,this,param1));
            return param1;
         }
         return null;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_879 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(var_31 & 0);
            if(_loc7_ == WindowParam.const_386)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_801,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_536,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1305,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_303 && var_489 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1317,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1317,param3,param1)) : false;
            }
         }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_278 = var_23.rectangle.clone();
               var_59.x = var_22.x;
               var_59.y = var_22.y;
               var_59.width = var_22.width;
               var_59.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_377,this,var_23));
            }
            else
            {
               var_278.x = 0;
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_238,_type,var_86,var_31,_context,var_22,null,var_570,properties,var_572.concat(),_id) as WindowController;
         _loc2_.var_489 = var_489;
         _loc2_.var_303 = var_303;
         _loc2_.var_850 = var_850;
         _loc2_.var_278 = var_278.clone();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1284,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_58,false);
         _loc1_.type = WindowNotifyEvent.const_1156;
         update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_489;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_637;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
