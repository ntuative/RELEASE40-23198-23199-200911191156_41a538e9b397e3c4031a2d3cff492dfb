package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private var var_643:ISkinContainer;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_349:
               ...
               break;
            case WindowRedrawFlag.const_786:
               var_644 = var_643.getTheActualState(param1.type,param1.style,param1.state);
               if(var_644 != var_961)
               {
                  var_226 = true;
                  _loc4_ = true;
      ...
      {
         return var_643.getTheActualState(param1.type,param1.style,param1.state) != var_961;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_750) : uint(const_479);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_644) ? uint(const_749) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_749)
               {
                  ...
                  if(var_226)
                  {
                     ...
                     _loc6_.draw(param1,var_97,var_97.rect,var_644,false);
      ...
      {
         var _loc2_:ISkinRenderer = var_643.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_968)
            {
               _loc2_ = var_643.getSkinRendererByType(param1.type,WindowStyle.const_968);
            }
         }
         return _loc2_;
      }
