package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_998:String = "_CONTENT";
      
      private static const const_996:String = "_HEADER";
      
      private static const const_997:String = "_SCALER";
      ...
      private var var_1071:IHeaderWindow;
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_225);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_201);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_183);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1071 == null)
         {
            var_1071 = findChildByTag(const_996) as IHeaderWindow;
            if(!var_1071)
            {
      ...
      {
         return findChildByTag(const_997) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1284 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_33 == null)
         {
            var_33 = findChildByTag(const_998) as IWindowContainer;
            if(!var_33)
            {
