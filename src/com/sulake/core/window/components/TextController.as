package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2199:Rectangle = new Rectangle();
      ...
      protected var var_343:Number;
      
      protected var _field:TextField;
      
      protected var var_685:Boolean = false;
      ...
      {
         return new Rectangle(var_569 * maxScrollH,var_343 * maxScrollV,width,height);
      }
      ...
      {
         var_569 = param1;
         _field.scrollH = var_569 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1293,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_426,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_426,true));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_484,PropertyStruct.const_233,var_484 != TextFieldAutoSize.NONE));
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_569 = var_569;
         _loc1_.var_343 = var_343;
