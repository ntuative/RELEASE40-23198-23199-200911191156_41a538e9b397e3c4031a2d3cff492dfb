   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_335)
         {
            ...
            if(var_335)
            {
               var_335.addEventListener(WindowEvent.const_237,scrollBarEventProc);
               var_335.addEventListener(WindowEvent.const_185,scrollBarEventProc);
            }
         }
         return var_335;
      }
      ...
      override public function dispose() : void
      {
         if(var_335)
         {
            var_335.removeEventListener(WindowEvent.const_237,scrollBarEventProc);
            var_335.removeEventListener(WindowEvent.const_185,scrollBarEventProc);
            var_335 = null;
         }
         if(_cachedItemList)
         {
