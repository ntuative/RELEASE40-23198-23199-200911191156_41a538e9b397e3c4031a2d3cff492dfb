package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_128 = context.create(name + "::submenu","",WindowType.const_409,var_86,0 | 0,_loc1_,subMenuEventProc,null,0,null,["_EXCLUDE"]) as DropMenuController;
         }
         else
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_779)
         {
            if(param2 == var_128)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_279,var_86,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_435 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_435).setStateFlag(WindowState.const_44,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_513)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_436,getSubMenu(),subMenuEventProc);
                  var_513 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_430,this,null,true);
         update(this,_loc2_);
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_513 = false;
            getTitleText().text = var_435 < var_436.length && var_435 > -1 ? "null" : caption;
         }
      }
   }
}
