package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_856:String = "WKE_KEY_UP";
       
      
      private var var_606:KeyboardEvent;
      ...
      {
         _type = param1;
         var_606 = KeyboardEvent(param2);
         super(param1,param3,param4,param5,false);
      }
      
      public function get keyLocation() : uint
      {
         return var_606.keyLocation;
      }
      
      public function get shiftKey() : Boolean
      {
         return var_606.shiftKey;
      }
      
      public function get charCode() : uint
      {
         return var_606.charCode;
      }
      
      public function get keyCode() : uint
      {
         return var_606.keyCode;
      }
      
      public function get altKey() : Boolean
      {
         return var_606.altKey;
      }
      ...
      {
         return new WindowKeyboardEvent(_type,var_606,window,related,bubbles,cancelable);
      }
   }
}
