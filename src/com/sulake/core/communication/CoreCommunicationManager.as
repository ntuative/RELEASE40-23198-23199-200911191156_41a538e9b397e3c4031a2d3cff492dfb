package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager
   {
      ...
      private var var_1977:IConnectionStateListener;
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = var_664[_loc3_];
      ...
      {
         var _loc3_:Array = var_664[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in var_1215)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:Class = var_663[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_865:
               _loc3_ = new SocketConnection(param1,this,var_1977);
               break;
            default:
