package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_461:XML;
      
      protected var var_1023:LoaderContext;
      ...
      protected var var_345:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_44 = new Array();
         var_488 = new Array();
         var_1023 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_345 = new AssetLibrary("lib-" + var_573++);
         var_44.push(var_345);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_345.createAsset(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_345.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_345.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_345.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return var_345.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_345.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_345.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_345.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_345.loadFromArchive(param1,param2);
      }
