package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2220:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_426 = [];
         var_427 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_392,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_406,onContentLoaded);
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_359.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_359.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_50.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_426.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_426.splice(_loc2_,1);
            }
            if(false)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_359.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_359.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
