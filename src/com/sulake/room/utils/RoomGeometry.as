package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_563:Number = 64;
      ...
      private var var_2207:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_89 = new Vector3d();
         var_960 = new Vector3d();
         var_1416 = 1;
         var_1415 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1414 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_381 != param1 * var_1414)
         {
            var_381 = param1 * var_1414;
            ++var_83;
         }
      }
      ...
      {
         if(var_382 != param1 * var_1415)
         {
            var_382 = param1 * var_1415;
            ++var_83;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_960.assign(_loc22_);
         }
         else
         {
            var_960.assign(_loc17_);
         }
         ++var_83;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_382;
         _loc2_.z *= var_381;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_960);
         if(_loc3_ < var_2207 || _loc3_ > var_2206)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_382;
            _loc2_.z *= var_381;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_960);
         }
      ...
      {
         return new Vector3d(0 * var_384,0 * var_382,0 * var_381);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_384,0 * var_382,0 * var_381);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_89;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_384,param2.y * var_382,param2.z * var_381);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_384,param3.y * var_382,param3.z * var_381);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_384,param4.y * var_382,param4.z * var_381);
