package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_700:String = "bg";
       
      
      private var var_1644:IContainerButtonWindow;
      
      private var var_1642:IContainerButtonWindow;
      
      private var var_1641:IContainerButtonWindow;
      
      private var var_1643:IContainerButtonWindow;
      
      private var var_312:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_312 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_1642 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1641 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1644 = initButton("room_invite",onInviteButtonClick,param1);
         var_1643 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_700);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:IBitmapWrapperWindow = param1.getChildByName(HabboFriendList.const_149) as IBitmapWrapperWindow;
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_312.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess,_loc3_.realName);
            this.var_312.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_28)
         {
            this.var_312.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_220)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_220 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1642,isEnableMinimailButton(_loc1_));
         setEnabled(var_1641,isEnableHomeButton(_loc1_));
         setEnabled(var_1644,isEnableInviteButton(_loc1_));
         setEnabled(var_1643,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_700);
