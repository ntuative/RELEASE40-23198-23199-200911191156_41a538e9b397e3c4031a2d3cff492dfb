package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_149:String = "face";
       
      
      private var _view:FriendListView;
      
      private var var_1662:IAvatarRenderManager;
      
      private var var_1328:AvatarSearchResults;
      
      private var var_136:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_722:FriendRequests;
      
      private var var_1665:int;
      
      var var_318:FriendCategories;
      
      private var var_199:IHabboToolbar;
      
      private var var_1664:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_405:FriendListTabs;
      
      private var var_1663:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1329:OpenedToWebPopup;
      ...
      {
         var_1664 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_318 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1328 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1329 == null)
         {
            var_1329 = new OpenedToWebPopup(this);
         }
         var_1329.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_722.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_722.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_405.findTab(FriendListTab.const_100).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_722.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_318.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_722 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_318.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_318.addCategory(new FriendCategory(FriendCategory.const_882,getText("friendlist.friends")));
         var_318.addCategory(new FriendCategory(FriendCategory.const_341,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_318.addFriend(new Friend(_loc4_));
         }
         ...
         getBuddyRequests();
         registerListeners();
         var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_318.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1662.createAvatarImage(param1,AvatarScaleType.const_96);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1662 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_722.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_405.findTab(FriendListTab.const_100);
      ...
      {
         var_1663 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_318.getFriendCount(param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1328.searchReceived(_loc2_.friends,_loc2_.others);
