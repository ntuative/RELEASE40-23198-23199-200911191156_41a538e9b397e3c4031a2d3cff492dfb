package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_274:int = 100;
      ...
      {
         return Math.ceil(this.var_212.length / const_274);
      }
      ...
      {
         if(this.var_715 >= this.getPageCount())
         {
            this.var_715 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_715 + 1) * const_274,this.var_212.length);
      }
