package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1345:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_316 && _loc4_.state != FriendRequest.const_278)
            {
      ...
      {
         var_1320 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1321 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1321.procedure = onDismissAllButtonClick;
         var_1320.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDeclineButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc4_.state = FriendRequest.const_278;
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_278)
         {
            _friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_951)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1320,_loc1_);
         setEnabled(var_1321,_loc1_);
      }
