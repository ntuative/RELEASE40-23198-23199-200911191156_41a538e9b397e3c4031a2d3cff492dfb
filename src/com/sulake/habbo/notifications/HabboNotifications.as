package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1020:String = "badges";
      ...
      private static const const_1024:String = "friendlist";
      
      private static const const_1021:String = "selectfurni";
      
      private static const const_1023:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_516:ParkBusDialogManager;
      
      private var var_1101:IHabboToolbar;
      
      private var var_364:HabboNotificationViewManager;
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1118);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1708)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_768);
            var_1708 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1069.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_799,_loc5_);
         }
      }
      ...
      {
         if(param1 != null && this.var_364 != null)
         {
            var_364.replaceIcon(param1);
         }
      }
      ...
      {
         if(var_364.isSpaceAvailable() && false)
         {
            var_364.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_516 == null)
         {
            var_516 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_516 != null)
         {
            var_516.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_901.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1069.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:BitmapData = var_537.getBadgeImage(_loc2_.badgeID);
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1088,_loc4_,_loc2_.badgeID);
         }
      }
      
      public function onBroadcastAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_207 || param2.type == WindowEvent.const_556)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc16_ = var_537.getProductData(_loc15_.productType);
               _loc17_ = var_537.getFurnitureData(_loc15_.furniClassId);
               _loc7_ = var_537.getProductData(_loc4_.localizationId);
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_768,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1069.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      {
         var_1101 = IHabboToolbar(param2);
         var_1101.events.addEventListener(HabboToolbarEvent.const_78,onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_203);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_537.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_869);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_869);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_78)
         {
            ...
            var_364 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_734["styles"],var_734["view"],var_1101);
            ...
            registerUpdateReceiver(var_364,1);
            registerUpdateReceiver(this,2);
            var_537.events.addEventListener(BadgeImageReadyEvent.const_160,onBadgeImage);
            var_1101.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
