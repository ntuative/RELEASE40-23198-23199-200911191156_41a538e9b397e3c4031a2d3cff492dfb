package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_367:ToolbarBarMenuAnimator;
      
      private var var_1170:Array;
      
      private var var_127:Number;
      
      private var var_1884:XML;
      ...
      {
         return var_1171.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1170.length)
         {
            _loc2_ = var_640.indexOf(var_1170[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_289[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_792 + _loc3_);
                  _loc3_ += var_1169;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_367);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_289[var_640.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1884.elements("menu");
         var _loc5_:int = 0;
