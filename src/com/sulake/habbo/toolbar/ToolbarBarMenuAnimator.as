package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1062:Number = 90;
      ...
      private var var_996:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_996 = param2;
         var_560 = new Timer(const_1061);
         var_560.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_996.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_299.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_299.splice(var_299.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_996.getIconLoc(param1.iconId);
      ...
      {
         return var_474[var_473.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_299[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_561[_loc3_] = new Array();
            }
            if(var_561[_loc3_].indexOf(param1) < 0)
            {
               var_561[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_763 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_763 || param1.desktop.height - param1.y < const_1076;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_474.length)
         {
            if(var_474[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_561[_loc3_].length)
                  {
                     repositionWindow(var_561[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
