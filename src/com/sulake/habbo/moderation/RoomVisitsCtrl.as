package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2011.clone());
         ...
         new OpenRoomTool(var_55,var_54,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_2011 = IWindowContainer(var_54.getXmlWindow("roomvisits_row"));
         ...
         var_55 = IFrameWindow(var_54.getXmlWindow("roomvisits_frame"));
