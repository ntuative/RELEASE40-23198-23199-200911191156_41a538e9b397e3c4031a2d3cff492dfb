package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_531:String = "issue_bundle_my";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_129 = new Map();
         var_739 = new Map();
         var_521 = new IssueBrowser(this,var_61.windowManager,var_61.assets);
         var_616 = [];
         var_738 = [];
         var_911 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_911.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_616 = var_616.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_739.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_739.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1098)
         {
            var_153.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_129)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_739.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_739.add(param1.issueId,_loc2_);
      ...
      {
         var _loc2_:* = var_911.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_61.soundManager.playSound(HabboSoundTypesEnum.const_785);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_739.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_129.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
