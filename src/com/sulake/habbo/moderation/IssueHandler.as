package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_366:UserInfoCtrl;
      
      private var var_61:ModerationManager;
      
      private var var_906:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.releaseBundle(var_152.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_366 = new UserInfoCtrl(_window,var_61);
         var_906 = new UserInfoCtrl(_window,var_61);
         var_366.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_152.getHighestPriorityIssue().reporterUserId);
         var _loc3_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_906.load(_loc3_,var_152.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_152.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_61,WindowTracker.const_825,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_61 != null && false && var_152 != null)
         {
            var_61.issueManager.removeHandler(var_152.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_366 = new UserInfoCtrl(_window,var_61);
            var_366.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_152.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_152.id,3);
         checkAutoHandling();
         dispose();
      }
