package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_733:int = 31536000;
      
      private static const const_735:int = 86400;
      
      private static const const_734:int = 3600;
      
      private static const const_732:int = 60;
      ...
      {
         if(param1 < 2 * const_732)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_734)
         {
            return Math.round(param1 / const_732) + " mins ago";
         }
         if(param1 < 2 * const_735)
         {
            return Math.round(param1 / const_734) + " hours ago";
         }
         if(param1 < 2 * const_733)
         {
            return Math.round(param1 / const_735) + " days ago";
         }
         return Math.round(param1 / const_733) + " years ago";
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_736.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_54.getXmlWindow("user_info"));
            var_736.addChild(_loc1_);
         ...
         _loc1_.findChildByName("modaction_but").procedure = method_6;
      ...
      private function method_6(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.windowTracker.show(new ModActionCtrl(var_54,_data.userId,_data.userName),_callerFrame,var_910,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_54,WindowTracker.const_916,_data.userId),_callerFrame,var_910,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.windowTracker.show(new RoomVisitsCtrl(var_54,_data.userId),_callerFrame,var_910,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.windowTracker.show(new SendMsgsCtrl(var_54,_data.userId,_data.userName),_callerFrame,var_910,false,true);
      }
