package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1360:IMessageComposer;
      ...
      {
         var_825 = IWindowContainer(var_54.getXmlWindow("chatlog_roomheader"));
         var_826 = IWindowContainer(var_54.getXmlWindow("chatlog_chatline"));
         var_476 = new Timer(300,1);
         var_476.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_55 = IFrameWindow(var_54.getXmlWindow("chatlog_frame"));
         ...
         var_54.connection.send(var_1360);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_825.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_55,var_54,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_826.clone());
         _loc4_.color = var_1243[param2.chatterId] != null ? (!!param3 ? 4293570819 : uint(4294955520)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_55,var_54,_loc6_,param2.chatterId);
         }
