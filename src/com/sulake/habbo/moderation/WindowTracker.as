package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1297:int = 7;
      
      public static const const_825:int = 3;
      
      public static const const_1169:int = 8;
      
      public static const const_916:int = 5;
      ...
      {
         var _loc2_:Dictionary = var_1426[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1426[param1] = _loc2_;
         }
         return _loc2_;
      }
