package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_882:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_293 && _connection != null)
         {
            _state = RoomSessionEvent.const_81;
            if(isPrivateRoom)
            {
      ...
      {
         return var_882 as IUserDataManager;
      }
