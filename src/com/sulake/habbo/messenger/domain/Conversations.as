package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1200:int = 1;
       
      
      private var _closedConversations:Array;
      
      private var var_395:IConversationsDeps;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_715,0,var_395.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = var_395.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_395.getTabCount());
      ...
      {
         return var_395.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         while(_startIndex + var_395.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var_395.addMsgToView(_loc3_,_loc4_);
      }
      ...
      {
         return new Message(Message.const_705,0,getOnlineText(param1),Util.getFormattedNow());
      }
      ...
      public function setFollowingAllowedAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         if(_loc3_.selected)
         {
            var_395.refresh(false);
         }
      }
      
      public function addTestUser() : void
      {
         this.addConversation(var_1200++);
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_395.addMsgToView(_loc3_,param1);
