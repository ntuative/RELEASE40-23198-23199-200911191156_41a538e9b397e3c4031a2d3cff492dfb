package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_469:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_124];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_124:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(var_665.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
      ...
      {
         return [RoomWidgetChatMessage.const_571,RoomWidgetChatSelectAvatarMessage.const_707];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_571:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_124,_container.roomSession,0,"Version 23198-23199-200911191127");
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_390);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_707:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_801 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_801);
            }
            if(var_469 == null)
            {
               var_470.x = 0;
               var_470.y = 0;
               var_470.z = 0;
               var_469 = _loc4_.getScreenPoint(var_470);
               var_801 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_470.x = 0;
            var_470.y = 0;
            var_470.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_470);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_469.x || _loc8_.y != var_469.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_469,_loc5_));
