   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_199 + " " + _loc6_);
            if(var_199 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_823,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_199.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_91:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_91));
               break;
            case HabboHelpTutorialEvent.const_442:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_366));
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_687,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               ...
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_91,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_687,onFigureUpdate);
         }
         var_28 = _container.inventory;
         if(var_28 != null)
         {
            (var_28 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_805,onAvatarEffectsChanged);
            (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_557,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            ...
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_91,onHelpTutorialEvent);
         }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_694);
         _loc1_.push(RoomWidgetDanceMessage.const_562);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_584);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_696);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_595);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_507);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_629);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_513);
         _loc1_.push(RoomWidgetStopEffectMessage.const_616);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1251);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_948);
         _loc1_.push(RoomWidgetToolbarMessage.const_664);
         _loc1_.push(RoomWidgetToolbarMessage.const_564);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_702);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1102);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_922);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_693);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_612);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_578);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_646);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1197);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_654));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_612:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetWaveMessage.const_694:
               if(_container != null && false)
               {
            ...
            case RoomWidgetDanceMessage.const_562:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_584:
               if(var_28 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_696:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_595:
               if(var_28 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_513:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_80 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_676)
               {
                  var_80.openCatalogPage(CatalogPageName.const_294,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_629:
               ...
               if(var_28 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_776:
                        var_80.openCatalogPage(CatalogPageName.const_1153,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_982:
                        var_28.toggleInventoryPage(InventoryCategory.const_231);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1203:
                        var_28.toggleInventoryPage(InventoryCategory.const_74);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1090:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_507:
            case RoomWidgetStopEffectMessage.const_616:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_807:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1272:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_948:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_693:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_664:
               _loc5_ = param1 as RoomWidgetToolbarMessage;
               if(var_199)
               {
                  var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_28 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_564:
               ...
               if(var_199)
               {
                  var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_375,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_702:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_381,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_969));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_381,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1286));
                     }
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_578:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_646:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_321,_container.soundManager.volume));
               break;
