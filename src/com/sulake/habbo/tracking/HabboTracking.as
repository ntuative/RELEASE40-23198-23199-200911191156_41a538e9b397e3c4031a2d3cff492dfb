package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private var var_1232:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1232 = new LagWarningLogger();
         var_1231 = new Array(const_761);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1311,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1309,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1202,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_539,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_787,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_643:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_178)
         {
            Component(var_178).events.addEventListener(HabboConfigurationEvent.const_17,onConfigurationLoaded);
            if(var_233 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_481.events.addEventListener(AdEvent.const_436,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_787,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_539,String(true));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_481)
            {
               var_481.release(new IIDHabboAdManager());
               var_481 = null;
            }
            if(_navigator)
            {
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_458,onLagWarningEvent);
               }
            }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_643,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_632,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_57,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_446,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_458:
               var_1232.registerWarning(LagWarningLogger.const_849);
         }
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_178)
         {
            Component(var_178).events.removeEventListener(HabboConfigurationEvent.const_17,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_458,onLagWarningEvent);
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_632)
         {
            trackLoginStep(HabboLoginTrackingStep.const_24);
         }
         else if(param1.type == HabboHotelViewEvent.const_446)
         {
