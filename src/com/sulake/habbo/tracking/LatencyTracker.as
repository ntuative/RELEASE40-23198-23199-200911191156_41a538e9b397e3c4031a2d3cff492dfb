package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1388 = getTimer();
         var_448.add(var_1143,var_1388);
         _connection.send(new LatencyPingRequestMessageComposer(var_1143));
         ++var_1143;
      }
      ...
      public function init() : void
      {
         ...
         var_1385 = int(var_178.getKey("latencytest.interval"));
         var_1387 = int(var_178.getKey("latencytest.report.index"));
         var_1809 = int(var_178.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(var_448 == null || var_154 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = var_448.getValue(_loc2_.requestId);
         var_448.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         var_154.push(_loc4_);
         if(var_154.length == var_1387 && var_1387 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1386) > var_1809 || var_1386 == 0)
            {
               var_1386 = _loc9_;
