package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         var_54.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_47,onShowMenuEvent);
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_47)
         {
            ...
            hideToolbarIconHighlightArrow();
            var_54.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_442));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_510 = var_54.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         ...
         var_54.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MEMENU_ARROW,var_510));
      }
      
      public function dispose() : void
      {
         setToolbarIconHighlight(false);
         var_54.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_47,onShowMenuEvent);
      }
   }
}
