package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1354:int = 0;
      ...
      private var var_1833:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23198-23199-200911191127");
         var_199 = param5;
         var_117 = new Map();
         var_117.add(HabboHelpViewEnum.const_1123,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_126,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_449,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_236,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_179,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_567,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_276,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_603,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_202,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary)));
         ...
         var_117.add(HabboHelpViewEnum.const_585,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_252 == HabboHelpViewEnum.const_126 || false)
         {
            return;
         }
         if(var_374 == null)
      ...
      {
         return var_117.getValue(var_252);
      }
      ...
      {
         var_1832 = param1;
         var _loc2_:IHelpViewController = var_117.getValue(HabboHelpViewEnum.const_126) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_202:
               ...
               break;
            case CallForHelpResultEnum.const_770:
      ...
      {
         var _loc3_:* = null;
         if(var_252 == HabboHelpViewEnum.const_126)
         {
            return;
         }
         if(true)
         {
            ...
            var_534.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_534[1],var_534[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_534[0],var_534[0].rect,new Point(0,0));
         }
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_199 != null)
            {
               var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_41.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_686));
      }
