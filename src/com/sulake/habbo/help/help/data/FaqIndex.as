package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_627:FaqCategory;
      ...
      {
         super();
         var_627 = new FaqCategory(-999,"${help.faq.title.urgent}");
      ...
      {
         var _loc4_:* = null;
         if(var_627.hasItem(param1))
         {
            var_627.getItem(param1).answerText = param2;
         }
