package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      {
         (_context as CoreComponent).error("Could not load external variables. Client startup failed!",true,CoreComponent.const_1294);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1000[param1] as String;
         return _loc2_ != null;
      }
      ...
      {
         var _loc4_:String = var_1000[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_2036);
