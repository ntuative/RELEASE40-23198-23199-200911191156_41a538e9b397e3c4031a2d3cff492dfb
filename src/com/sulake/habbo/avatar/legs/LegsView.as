package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_675["null"] = new AvatarEditorGridView(param1,FigureData.const_143,param2,param3);
         var_675["null"] = new AvatarEditorGridView(param1,FigureData.const_155,param2,param3);
         var_675["null"] = new AvatarEditorGridView(param1,FigureData.const_125,param2,param3);
         attachImages();
