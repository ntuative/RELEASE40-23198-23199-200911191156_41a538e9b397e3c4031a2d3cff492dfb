package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1272:IWindowContainer;
      ...
      private var var_1452:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1272 == null)
         {
            ...
            var_1272 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1497 == null)
         {
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_974 != null)
         {
            toggleCategoryView(var_974,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1452 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_974 = param1;
         var_1452.setSelected(var_1452.getSelectableByName(param1));
         _window.invalidate();
      }
