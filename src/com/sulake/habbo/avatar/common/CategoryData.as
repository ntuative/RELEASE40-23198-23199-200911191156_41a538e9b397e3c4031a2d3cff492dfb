package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_585 > -1)
         {
            return var_310[var_585] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_585 >= 0)
         {
            _loc3_ = var_310[var_585];
            _loc3_.isSelected = false;
         }
         if(var_310.length > param1)
         {
            _loc2_ = var_310[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_585 = param1;
