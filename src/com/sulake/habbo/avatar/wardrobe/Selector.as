package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Selector
   {
      ...
      public function Selector(param1:HabboAvatarEditor)
      {
         ...
         if(_window != null)
         {
            var_414 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
         _loc3_ = _assetLibrary.getAssetByName("selectOutfit") as BitmapDataAsset;
         var_866 = (_loc3_.content as BitmapData).clone();
         _loc3_ = _assetLibrary.getAssetByName("selectOutfit_over") as BitmapDataAsset;
         var_1040 = (_loc3_.content as BitmapData).clone();
         update(var_866);
      ...
      {
         var_414.bitmap = new BitmapData(var_414.width,var_414.height,true,16777215);
         var _loc2_:int = (0 - param1.width) / 2;
         var _loc3_:int = 0 - param1.height;
         var_414.bitmap.copyPixels(param1,param1.rect,new Point(_loc2_,_loc3_));
      }
