package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_2095 = parseInt(param1.@precedence);
         var_2099 = String(param1.@activepartset);
         var_2098 = String(param1.@assetpartdefinition);
         var_2094 = String(param1.@lay);
         var_1183 = String(param1.@geometrytype);
         var_1549 = Boolean(parseInt(param1.@main));
         var_2100 = Boolean(parseInt(param1.@method_7));
         var_2096 = Boolean(parseInt(param1.@animation));
      ...
      {
         return var_1155.concat(getTypePrevents(param1));
      }
