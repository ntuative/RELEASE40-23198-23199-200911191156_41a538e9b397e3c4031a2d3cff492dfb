package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_892:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_892.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_894)
         {
            ...
            var_604["null"] = new FigureData(this);
            var_604["null"] = new FigureData(this);
            _loc1_ = var_604["null"];
            _loc2_ = var_604["null"];
            ...
            var_318 = new Map();
            var_318.add(AvatarEditorCategory.const_769,new GenericModel(this));
            var_318.add(AvatarEditorCategory.const_45,new HeadModel(this));
            var_318.add(AvatarEditorCategory.const_327,new TorsoModel(this));
            var_318.add(AvatarEditorCategory.const_1225,new LegsModel(this));
            var_318.add(AvatarEditorCategory.const_505,new WardrobeModel(this));
            var_894 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_318.getValue(AvatarEditorCategory.const_505);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_318.getValue(AvatarEditorCategory.const_505);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_892.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1272.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1272.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_318.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_362 == null)
            {
               var_362 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_53,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_362.addChild(_view.window);
               var_362.center();
               var_362.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_769);
         if(var_178 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1069 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_557,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_892 = var_1069.getFigureData(AvatarType.const_99);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_893 = param3;
         var _loc4_:FigureData = var_604[param2];
         if(_loc4_ == null)
         {
            return;
         }
