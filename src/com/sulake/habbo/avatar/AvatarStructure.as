package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1678:PartOffsetData;
      ...
      private var var_1334:AvatarStructureDownloadSet;
      
      private var var_728:AvatarActionManager;
      
      private var var_151:IAssetLibrary;
      
      private var var_433:FigureData;
      
      private var var_2159:IAssetLibrary;
      
      private var var_1284:Boolean = false;
      
      private var var_603:AnimationManager;
      
      private var var_1679:AvatarRenderManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_1334 = new AvatarStructureDownloadSet();
         var_603 = new AnimationManager();
         var_729 = param4;
         var_1678 = PartOffsetData.getInstance(param3);
      }
      ...
      {
         return var_728.getActionDefinitionWithState(param1);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_603.getAnimation(param1);
      }
      ...
      public function init(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_729)
         {
            case AvatarType.const_99:
               ...
               if(!var_433.parse(_loc5_))
               {
                  return;
               }
               var_1334.add(new AvatarStructureDownload(var_151,_loc2_,var_433));
               _loc6_ = true;
               break;
            case AvatarType.PET:
         ...
         if(_loc6_)
         {
            var_1334.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
         }
         else
         {
            onStructureReady();
      ...
      {
         return var_728.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_728.getActionDefinition(param1);
      }
      
      private function initActions() : void
      {
         var_728 = new AvatarActionManager(var_151,var_729);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_603.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_728.getDefaultActionType();
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc8_ = var_603.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            if(_loc23_ != null)
            {
               _loc24_ = var_433.getPalette(_loc23_.paletteID).getColor(_loc22_);
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_151.hasAsset("dance" + _loc1_))
         {
            ...
            var_603.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_433.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_433.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      ...
      {
         return var_728.sortActions(param1);
      }
   }
}
