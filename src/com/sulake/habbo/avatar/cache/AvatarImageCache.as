package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1356:int = 60000;
      ...
      private var var_767:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_639)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_394)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_85.getParts(param1,(var_767 as AvatarImage).getFigure(),_loc6_,var_1183,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_85.getCanvas(var_197,var_1183);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1112[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_792 || _loc32_ == AvatarAction.const_656) && (_loc6_ == AvatarBodyPartType.const_327 || _loc6_ == AvatarBodyPartType.const_1261 || _loc6_ == AvatarBodyPartType.const_1318) && _loc7_.color != null)
               {
