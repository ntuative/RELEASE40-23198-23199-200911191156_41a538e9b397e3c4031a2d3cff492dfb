package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_999:uint = 1;
      ...
      private var var_1075:ProfilerAgentTask;
      
      private var var_1073:IEventDispatcher;
      
      private var var_2217:uint = 0;
      
      private var var_1072:ProfilerAgentTask;
      
      private var var_1074:ProfilerOutput;
      
      private var var_595:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            _instance = this;
            var_1073 = Component(param1).events;
            var_716 = new Array();
      ...
      {
         return var_279[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_279[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_595 = new WindowRenderer(_loc4_);
         var_279 = new Array(const_328);
         var _loc6_:int = 0;
         while(_loc6_ < const_328)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_595,this,_localization,var_187,new Rectangle(0,0,var_187.stageWidth,var_187.stageHeight),this);
            var_279[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_362 = var_279[const_999];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_362.getMouseCursor().defineCustomCursorType(MouseCursorType.const_275,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_362.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1287,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_279[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_279.pop()).dispose();
            }
            if(var_1074 != null)
            {
               var_1074.dispose();
      ...
      {
         return var_279[param1].getDesktopWindow().getChildAt(var_362.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1074 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1074 = new ProfilerOutput(_loc3_,this,var_595);
               var_1075 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1075);
               var_1072 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1072);
               var_881 = true;
            }
         }
      }
      ...
      {
         return var_362.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_848.length > 0)
         {
            var_1073.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_328 - 1;
            while(_loc2_ >= 0)
            {
               var_279[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_881)
         ...
         var_1073.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_328)
         {
            var_279[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_881)
         {
         ...
         if(WindowContext.var_848.length > 0)
         {
            WindowContext.var_848.flush();
         }
         if(WindowContext.var_1271.length > 0)
         {
            WindowContext.var_1271.flush();
         }
         var_1073.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_716[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_716[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_362.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1263,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1333,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1229,new Date().getTime().toString());
