package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_357.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_357.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_357.removeStopEventListener(refresh);
            var_357 = null;
            _windowManager = null;
            var_595 = null;
            _disposed = true;
