package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1228:uint = 2;
       
      
      private var var_783:IProtocolDecoder;
      
      private var var_965:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_965 = new WedgieEncoder();
         var_783 = new WedgieDecoder();
      }
