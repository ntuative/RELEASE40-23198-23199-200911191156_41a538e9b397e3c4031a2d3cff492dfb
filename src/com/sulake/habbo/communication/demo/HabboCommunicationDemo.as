package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1812:PseudoRandom;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_320:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_814:
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1147,var_1814));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1352,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1812);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1352,"/");
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1147 = _habboConfiguration.getKey("flash.client.url","");
         ...
         if(var_634 != null)
         {
            var_75.mode = HabboConnectionType.const_411;
            var_75.initConnection(HabboConnectionType.const_242);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            var_75.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(method_7));
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_643);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1812 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_75.mode)
         {
            case HabboConnectionType.const_411:
               _loc6_ = "";
               ...
               var_940 = _loc4_;
               var_173.loadBannerImage(_loc7_ + "?token=" + var_940,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1283:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1130:
