package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private const const_1352:String = "fuselogin";
      
      public var name:String = "";
      
      private var _window:IWindowContainer;
      
      private var var_337:HabboCommunicationDemo;
      ...
      {
         var_337.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_337.shockwaveClientUrl = var_120.shockwaveClientUrl;
         var_337.ssoTicket = var_120.ticket;
         var_120.removeEventListener(SSOTicket.const_309,onParsedTicketSuccess);
         var_120.removeEventListener(SSOTicket.const_260,onParsedTicketFailure);
         var_120 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1352,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_337 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_337.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_282,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_337.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1352,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_337.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_337.habboCommunication.habboWebLogin(name,password);
         var_120 = new SSOTicket(var_337.assets,_loc2_,_loc1_);
         var_120.addEventListener(SSOTicket.const_309,onParsedTicketSuccess);
         var_120.addEventListener(SSOTicket.const_260,onParsedTicketFailure);
      }
