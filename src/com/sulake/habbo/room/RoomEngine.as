package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, ICoreUpdateReceiver
   {
      ...
      private static const const_474:String = "room";
      
      private static const const_730:int = -2;
      
      private static const const_473:String = "temporary_room";
      
      private static const const_268:String = "object_icon_sprite";
      
      private static const const_729:int = -3;
      
      private static const const_728:String = "overlay";
      ...
      private var var_359:IRoomObjectVisualizationFactory = null;
      ...
      private var var_518:NumberBank;
      ...
      private var var_607:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_285 = new Map();
         var_518 = new NumberBank(1000);
         var_902 = new Map();
         var_284 = new Map();
         var_69 = new RoomObjectEventHandler(this);
         var_607 = new RoomMessageHandler(this);
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_501) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_586) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_604) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_599) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_146);
            if(_loc7_ != null)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_359 != null)
         {
            var_359.release(new IIDRoomObjectVisualizationFactory());
            var_359 = null;
         }
         if(var_48 != null)
         {
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_645);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_617);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_672);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_797);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_838);
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.getModel() != null)
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_828) > 0)
               {
                  ...
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_459,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_541,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_638,var_115,var_116,param2,param3));
            }
         }
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_494,param3);
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_48 != null)
         {
            ...
            var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_218);
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_180,_loc10_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_296,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_216,_loc11_,true);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_265,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
         return true;
      }
      ...
      {
         if(_roomObjectFactory == null || var_359 == null || var_48 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_1710)
         {
            return;
         }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1163,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_729,RoomObjectCategoryEnum.const_218);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_115,var_116,var_1104);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_115,var_116,var_1104);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_359 = param2 as IRoomObjectVisualizationFactory;
         if(var_25 != null)
         {
            var_25.visualizationFactory = var_359;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_189,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_437,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_452,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_240,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_538,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_447,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_433,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_56,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_399,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_451,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_244,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_368,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_315,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_277,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_400,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_919,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_352,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(AvatarWalkWarpingWarningEvent.const_458,warningEventHandler);
            }
         }
      }
            ...
            if(_loc13_ != null && _loc13_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_29:
                     _loc10_ = String(_loc13_.getModel().getNumber(RoomObjectVariableEnum.const_180));
                     break;
                  case RoomObjectCategoryEnum.const_34:
                     _loc10_ = _loc13_.getModel().getString(RoomObjectVariableEnum.const_151);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_303);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_560)
         {
            var_1710 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_180,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_296,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_216,_loc11_,true);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_481.events.addEventListener(AdEvent.const_436,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_728) as Sprite;
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0) : ImageResult
      {
         ...
         var _loc9_:IRoomInstance = var_48.getRoom(const_473);
         if(_loc9_ == null)
         {
            _loc9_ = var_48.createRoom(const_473,null);
            if(_loc9_ == null)
            {
               return _loc8_;
            }
         }
         var _loc10_:int = var_518.reserveNumber();
         ...
         switch(_loc11_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_29:
               _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_180,int(param2));
               break;
            case RoomObjectCategoryEnum.const_34:
               _loc12_.getModelController().setString(RoomObjectVariableEnum.const_151,param2);
               break;
            case RoomObjectCategoryEnum.const_52:
               if(param2 != null)
               {
                  ...
                  if(_loc16_.length >= 3)
                  {
                     ...
                     _loc20_.addPlane(RoomPlaneData.const_144,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc20_.addPlane(RoomPlaneData.const_144,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_695,_loc17_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_596,_loc18_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_581,_loc19_);
                     if(param6 != null)
                     {
                        _loc22_ = null;
                        _loc23_ = "undefined_" + _loc10_;
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_459,_loc23_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_902.add(String(_loc10_),param5);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_872,param4,true);
         }
         else
         {
            _loc9_.disposeObject(_loc10_,_loc11_);
            var_518.freeNumber(_loc10_ - 1);
            _loc8_.id = 0;
         }
         _loc14_.dispose();
         return _loc8_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_730,RoomObjectCategoryEnum.const_218);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1344 - _loc12_.width / 2;
               _loc11_.y = var_1345 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_354,var_115,var_116,-1,RoomObjectCategoryEnum.const_204));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_69 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_269,const_474);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_115,var_116,var_1104);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1344 - _loc6_.data.width / 2;
               _loc11_.y = var_1345 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_25 != null)
         {
            ...
            var_25.addGraphicAsset(var_25.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_285,param1.image,true);
            var_25.addGraphicAsset(var_25.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_833,param1.adWarningL,true);
            var_25.addGraphicAsset(var_25.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_899,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_778,RoomObjectVariableEnum.const_285,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_25 != null)
         {
            _events.addEventListener(RoomContentLoader.const_560,onContentLoaderReady);
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_48.getRoom(const_473);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               var_518.freeNumber(_loc10_ - 1);
               _loc13_ = var_902.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_830,param6,true);
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_269,const_474,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_628,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_645,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_501,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_604,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_586,_loc18_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_983,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_494,param3);
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_459,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_184);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_617,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_672,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_617,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_672,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_797,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_838,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_730,const_1027,RoomObjectCategoryEnum.const_218);
         _loc7_.createRoomObject(const_729,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_218);
         return _loc7_;
      }
