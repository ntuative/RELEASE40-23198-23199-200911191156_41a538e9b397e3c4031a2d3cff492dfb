package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1467:int = 255;
      
      private var var_1465:int = 255;
      
      private var var_1229:uint = 16777215;
      
      private var var_994:uint = 16777215;
      
      protected var var_82:RoomPlaneParser = null;
      
      private var var_812:int = 0;
      
      private var var_1089:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_494:
                  _loc2_.setString(RoomObjectVariableEnum.const_695,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_719:
                  _loc2_.setString(RoomObjectVariableEnum.const_596,_loc3_.value);
                  break;
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_459:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_184)
                  {
                     _loc8_ = "null";
                  }
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_898,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_773,int(_loc5_.bgOnly));
            var_1229 = _color;
            var_1467 = var_1089;
            var_994 = _loc11_;
            var_1465 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_600,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1135,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1214,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1198,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_144 || _loc13_ == RoomPlaneData.const_254)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_812)
         {
            ...
            {
               _loc6_ = var_1229 >> 16 & 255;
               _loc7_ = var_1229 >> 8 & 255;
               _loc8_ = var_1229 & 255;
               _loc9_ = var_994 >> 16 & 255;
               _loc10_ = var_994 >> 8 & 255;
               _loc11_ = var_994 & 255;
               _loc12_ = (_loc1_ - var_812) / var_1466;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1467 + (var_1465 - var_1467) * _loc12_;
               _color = _loc2_;
               var_1089 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_600,_loc2_);
         }
      }
   }
}
