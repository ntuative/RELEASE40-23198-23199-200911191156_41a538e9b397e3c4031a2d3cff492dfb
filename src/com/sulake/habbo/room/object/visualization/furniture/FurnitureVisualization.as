package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2142:Number = NaN;
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc7_ != null)
               {
                  ...
                  if(_loc4_ < spriteCount - 1)
                  {
                     ...
                     _loc6_.color = getSpriteColor(_loc4_,var_2143,param1);
                  ...
                  else
                  {
                     ...
                     {
                        _loc9_ *= object.getModel().getNumber(RoomObjectVariableEnum.const_168);
                     }
                     _loc6_.alpha = _loc9_;
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_827:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_803:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2143 = _loc3_.getNumber(RoomObjectVariableEnum.const_180);
      ...
      protected function getSpriteAlpha(param1:int, param2:int, param3:int) : int
      {
         ...
         if(_loc5_ != null)
         {
            _loc6_ = Number(_loc5_.getNumber(RoomObjectVariableEnum.const_168));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_274 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2142)
         {
            _loc4_ = _loc3_.getDirection().x - (param2 + 135);
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = _data.getDirectionValue(_loc4_,param1);
            _direction = _loc5_;
            var_274 = _loc3_.getUpdateID();
            var_2142 = param2;
            return true;
         }
         return false;
