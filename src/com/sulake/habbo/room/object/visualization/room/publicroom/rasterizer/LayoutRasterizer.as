package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_929:Point = null;
      
      private var var_447:Array;
      
      private var var_931:LayoutRasterizerData = null;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_930 = param1;
         var _loc3_:LayoutRasterizerData = var_66.getValue(var_625);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1130 = RoomObjectVariableEnum.const_833;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1130 = RoomObjectVariableEnum.const_899;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_930 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_930 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_930 + _adBgIndex);
            _loc5_ = param1.getSprite(var_930 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1130);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_418;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1776);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_625)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_931 = var_66.getValue(var_625);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_66.getValue(var_625);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_931.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_929.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_929.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_324.indexOf(_loc10_) >= 0 && var_446)
            {
               param1 = var_324.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_445[param1]);
                  if(_loc9_ != null)
                  {
                     param2.asset = _loc9_.asset;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_447[param1];
               }
               var_324.splice(param1,1);
               var_445.splice(param1,1);
               var_447.splice(param1,1);
               if(false)
               {
                  var_446 = false;
               }
