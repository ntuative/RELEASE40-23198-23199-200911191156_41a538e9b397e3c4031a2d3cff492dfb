package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_642:PlaneVisualization = null;
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_642 = var_385.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_642 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_385 != null)
         {
            ...
            {
               _loc1_ = var_385.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
