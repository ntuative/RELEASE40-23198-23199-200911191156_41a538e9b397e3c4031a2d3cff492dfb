package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1391:int = 16777216;
      
      public static const const_1383:int = 1;
       
      
      private var var_2208:int = 69069;
      
      private var var_1248:int = 1;
      
      private var var_2209:int = 5;
      
      private var var_1477:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1477 * param2);
      }
      ...
      {
         var _loc1_:int = var_2208 * var_1248 + var_2209;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
