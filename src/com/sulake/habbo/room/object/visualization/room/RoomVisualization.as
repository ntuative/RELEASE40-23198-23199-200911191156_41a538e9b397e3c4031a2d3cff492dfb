package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1014:int = 16777215;
      
      public static const const_1317:int = 10066329;
      
      private static const const_1012:int = 13421772;
      
      public static const const_1329:int = 16777215;
      
      private static const const_1346:int = 0;
      
      public static const const_1275:int = 16777215;
      
      private static const const_1013:int = 10066329;
      
      private static const const_1015:int = 10066329;
      
      public static const const_1124:int = 13421772;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_111.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1342;
               }
               if(var_82.getPlaneType(_loc4_) == RoomPlaneData.const_142)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_247 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_596);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_695);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_581);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_898);
            if(_loc8_ != var_1701)
            {
               updatePlaneMasks(_loc8_);
               var_1701 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_600));
            if(_loc9_ != var_899)
            {
               var_899 = _loc9_;
            }
            var_1700 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_773));
         ...
         while(_loc4_ < var_111.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_170)
            {
               _loc12_ = uint(_loc11_.color);
               if(var_1700)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_899 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_899 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_899 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_983);
         var _loc7_:int = 0;
         while(_loc7_ < var_82.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_247,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_111.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_247 && param2 != null)
               {
                  _loc5_.id = param2;
               }
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_111.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_247 || _loc3_.type == RoomPlane.const_170 && _loc8_ == RoomPlaneBitmapMaskData.const_184)
                  {
