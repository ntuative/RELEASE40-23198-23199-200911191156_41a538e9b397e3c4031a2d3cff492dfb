package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_188:int = 4;
      
      public static const const_577:int = 6;
      
      public static const const_266:int = const_97;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1964 = param6;
         var_1963 = param7;
         var_737 = new Vector3d();
         if(var_1461 == const_577)
         {
            var_1240 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1472 == const_97)
         {
            _loc5_ = new Rectangle(0,0,var_38.width,var_475);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_475,var_38.width,var_475);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_38 != null)
            {
               if(var_38.width == param2 && var_38.height == param3 && Vector3d.isEqual(var_737,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_475,param6,param7);
                     return param1;
                  }
                  return var_38;
               }
