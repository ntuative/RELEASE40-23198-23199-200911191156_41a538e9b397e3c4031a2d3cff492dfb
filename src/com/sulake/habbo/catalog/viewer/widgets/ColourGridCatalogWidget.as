package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_282 != null)
         {
            _loc2_ = var_282.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      override public function init() : void
      {
         ...
         var_1188 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1188) as IWindowContainer;
            _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc2_.background = true;
            _loc2_.color = 4294967295;
            _loc2_.width = var_650.width;
            _loc2_.height = var_650.height;
            _colourGrid.addGridItem(_loc2_);
            _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_650.width,var_650.height,true,0);
               _loc3_.bitmap.copyPixels(var_650,var_650.rect,new Point(0,0));
            }
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_870.width,var_870.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_870,var_870.rect,new Point(0,0),null,null,true);
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var_870 = _loc4_.content as BitmapData;
         populateColourGrid();
