package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_542[var_967] as Array;
      ...
      {
         var _loc2_:Offer = var_542[var_967][var_1942];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_445 || _loc1_.pricingModel == Offer.const_456)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_136 || _loc3_.productType == ProductTypeEnum.const_166)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (var_542[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_542)
         {
            if(var_1942 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1942] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_967 = var_860.getGridItemIndex(param1.view);
