package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_871:ITextFieldWindow;
      ...
      {
         super.init();
         var_871 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_871 != null)
         {
            var_871.addEventListener(WindowKeyboardEvent.const_856,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_871.text));
      }
   }
}
