package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_884 != null)
         {
            var_884.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_885 != null)
         {
            var_885.removeEventListener(WindowKeyboardEvent.const_138,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_884 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_884 != null)
         {
            var_884.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_885 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_885 != null)
         {
            var_885.addEventListener(WindowKeyboardEvent.const_138,windowKeyEventProcessor);
         }
      }
