package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1098.text = "${" + _loc3_.name + "}";
            var_1097.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1098.text = "${" + _loc2_.localizationId + "}";
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_441:
                  ...
                  if(var_562 != null)
                  {
                     ...
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_562,var_1237,var_1285);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_291:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_325,AvatarAction.const_642);
                              _loc13_.appendAction(AvatarAction.const_540,_loc6_.productClassId);
      ...
      {
         var_1098 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         var_1469 = new Point(var_91.x,var_91.y);
