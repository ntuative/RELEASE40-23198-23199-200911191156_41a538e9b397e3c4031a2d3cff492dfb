package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_623[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_985 = new Map();
         var_623 = recycler.getPrizeTable();
         if(var_623 == null)
         {
            return;
         }
         ...
         var_1761 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_623[0].prizes.length > 0)
         {
            select(var_623[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1761) as IWindowContainer;
