package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1334:String = "ctlg_";
      ...
      {
         return _localization.hasLinks(var_787);
      }
      ...
      {
         var _loc2_:String = const_1334 + param1;
         ...
         var_1283 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1283) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1089) as IWindowContainer;
         if(_loc1_ != null)
         {
      ...
      {
         return _localization.getLinks(var_787);
      }
