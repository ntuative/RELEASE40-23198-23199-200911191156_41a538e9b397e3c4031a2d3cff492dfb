package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1563:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param4;
         var_467 = new Map();
         var_467.add(FurniModel.const_40,new FurniGridView(var_87,FurniModel.const_40,_windowManager,_assetLibrary,_roomEngine));
         var_467.add(FurniModel.const_41,new FurniGridView(var_87,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  var_87.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  var_87.requestSelectedFurniToTrading();
                  break;
               default:
         ...
         else if(param1.type == WindowEvent.const_55)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_286);
            }
         }
      }
      ...
      {
         var _loc3_:GroupItem = var_87.getGroupItemInIndex(var_87.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_467.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_467.getValue(var_466);
         if(_loc4_ != null)
         {
         ...
         var_87.furniCategorySwitch(param1);
      }
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = var_467.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = var_87.getSelectedItemIndex();
         _loc4_ = var_87.getGroupItemInIndex(_loc3_,var_466);
         ...
         if(_loc12_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && var_87.canUserOfferToTrade())
            {
      ...
      {
         var _loc3_:FurniGridView = var_467.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
