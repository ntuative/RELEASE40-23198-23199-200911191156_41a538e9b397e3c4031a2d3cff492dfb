package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_286:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager, param7:IHabboConfigurationManager)
      {
         ...
         var_454 = new Timer(const_1044,1);
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_378.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_378.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         if(var_639 == null)
         {
            var_639 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc10_:IWindowContainer = var_639.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_74 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_41:
                  ...
                  break;
               case const_286:
                  _controller.toggleInventoryPage(InventoryCategory.const_222);
            }
         }
      }
      ...
      {
         if(var_770 && param1.type == RoomEngineObjectEvent.const_198)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_324 || _loc3_.category == FurniCategory.const_297 || _loc3_.category == FurniCategory.const_298)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_378 = new Map();
         var_378.add(const_40,new Array());
         var_378.add(const_41,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
