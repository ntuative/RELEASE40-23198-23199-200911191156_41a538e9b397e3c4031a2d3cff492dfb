package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_483 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_483.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_483.addGridItemAt(param1,param2);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            var_87.toggleItemSelection(_category,var_483.getGridItemIndex(param1.window));
            var_342 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_28 && var_342 != null && var_342 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_220)
         {
