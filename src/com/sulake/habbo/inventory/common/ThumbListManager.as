package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_924:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_524 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_524.width;
         var_95 = var_524.height;
         var_925 = param5;
         var_747 = param6;
         var_217 = Math.floor(var_925 / _thumbWidth);
         var_32 = new BitmapData(var_925,var_747);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_32.height < var_747)
         {
            _loc12_ = new BitmapData(var_32.width,var_747);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_524.width,var_524.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_524.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_524,var_524.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_924 != null)
         {
            _loc1_ = var_924.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_441 = resolveRowCountFromList();
         if(var_441 == 0)
         {
            var_32 = new BitmapData(var_925,var_747);
            return;
         }
         var_32 = new BitmapData(Math.max(var_217 * _thumbWidth,var_925),Math.max(var_441 * var_95,var_747),true,16777215);
         var_32.fillRect(var_32.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_441)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_217 && var_32.height < _loc3_.y * var_95)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_217 - 1),var_95);
         ...
         _loc4_ = new Rectangle(0,var_95,_thumbWidth * (var_217 - 1),0 - var_95);
