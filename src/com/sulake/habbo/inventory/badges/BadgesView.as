package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_87:BadgesModel;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_928 = _view.findChildByName("inactive_items") as IItemGridWindow;
         var_928.procedure = inactiveGridEventProc;
         var_927 = _view.findChildByName("active_items") as IItemGridWindow;
         var_927.procedure = activeGridEventProc;
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "wearBadge_button":
                  _loc3_ = var_87.getSelectedBadge();
                  if(_loc3_ != null)
                  {
                     var_87.toggleBadgeWearing(_loc3_.type);
                  }
            }
         }
      }
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc4_ = var_87.getBadgeFromActive(_loc3_);
            if(_loc4_ != null)
            {
               var_87.setBadgeSelected(_loc4_.type);
            }
         }
      }
      ...
      private function updateActionView() : void
      {
         ...
         var _loc2_:Badge = var_87.getSelectedBadge();
         if(_loc2_ == null)
         {
            _loc1_.disable();
            setBadgeName(null);
         ...
         else
         {
            ...
            _loc3_ = var_87.getBadges(1);
            if(_loc3_ != null && _loc3_.length >= var_87.getMaxActiveCount() && !_loc2_.isInUse)
            {
               _loc1_.disable();
            }
            else
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Array = var_87.getBadges(0);
         var _loc3_:int = 0;
         ...
         var _loc4_:Array = var_87.getBadges(1);
         _loc3_ = 0;
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc4_ = var_87.getBadgeFromInactive(_loc3_);
            if(_loc4_ != null)
            {
               var_87.setBadgeSelected(_loc4_.type);
            }
