package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2137:BitmapData;
      
      protected var var_857:Boolean;
      
      protected var var_2131:Boolean;
      
      protected var var_1515:int;
      ...
      private const const_1357:Number = 1;
      ...
      public function initImage() : void
      {
         ...
         if(var_2138 == FurniModel.const_40)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this);
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1280);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1282 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2137;
               _loc5_.visible = true;
            }
            else
            {
