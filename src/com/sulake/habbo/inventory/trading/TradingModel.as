package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_148:uint = 0;
      
      public static const const_1094:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_451 = false;
         var_637 = false;
         var_51.updateItemList(var_638);
         var_51.updateItemList(var_1157);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_51.alertPopup(TradingView.const_920);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               var_451 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               var_51.alertPopup(TradingView.const_924);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_451 + " OTHER: " + var_637);
         ...
         {
            case const_148:
               if(param1 == const_154 || param1 == const_212)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_51.setMinimized(param1 != InventoryCategory.const_74);
      ...
      public function close() : void
      {
         if(var_533)
         {
            if(_state != const_148 && _state != const_212)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_148;
            var_28.toggleInventorySubPage(InventorySubCategory.const_953);
            var_533 = false;
         }
         var_51.setMinimized(false);
      }
