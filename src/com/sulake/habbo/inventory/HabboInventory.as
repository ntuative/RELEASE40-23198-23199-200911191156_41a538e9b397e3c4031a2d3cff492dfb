package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1559:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            var_34.events.removeEventListener(RoomSessionEvent.const_81,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionEvent.const_98,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_414,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_98:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_414:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_57.getValue(InventoryCategory.const_655));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_57.getValue(InventoryCategory.const_74));
      }
      ...
      {
         var_188.clubPeriods = param1;
         var_188.clubDays = param2;
         var_188.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_805));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_57.getValue(InventoryCategory.const_222));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1559);
         }
      }
      ...
      {
         return AchievementsModel(var_57.getValue(InventoryCategory.const_301));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_793.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_793.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_57.getValue(InventorySubCategory.const_258));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_537 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_793.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1442 = new IncomingMessages(this);
      ...
      {
         return var_188.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_188.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_57.getValue(InventoryCategory.const_231));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_81,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionEvent.const_98,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_414,roomSessionEventHandler);
         ...
         var_57.add(InventoryCategory.const_74,_loc3_);
         var _loc4_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_537);
         var_57.add(InventoryCategory.const_231,_loc4_);
         var _loc5_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_57.add(InventoryCategory.const_655,_loc5_);
         var _loc6_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_537);
         var_57.add(InventoryCategory.const_301,_loc6_);
         var _loc7_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_57.add(InventorySubCategory.const_258,_loc7_);
         ...
         var_57.add(InventoryCategory.const_222,_loc9_);
