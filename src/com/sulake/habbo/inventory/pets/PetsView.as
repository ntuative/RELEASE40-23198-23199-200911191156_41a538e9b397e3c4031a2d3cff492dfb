package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_282:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_483 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_509 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_509.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_282 != null)
         {
            var_282.setSelected(false);
         }
         var_282 = param1;
         if(var_282 != null)
         {
            var_282.setSelected(true);
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_55)
         {
            ...
            {
               case "tab_floor":
                  var_87.switchCategory(FurniModel.const_40);
                  break;
               case "tab_wall":
                  var_87.switchCategory(FurniModel.const_41);
            }
            selectPetsTab();
         }
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_282.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var_87.placePetToRoom(param1,param2);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = var_509.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_483.removeGridItem(_loc2_.window);
         if(var_282 == _loc2_)
         {
            var_282 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_509.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_483.addGridItem(_loc2_.window);
            var_509.add(param1.id,_loc2_);
            if(var_282 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(false)
         {
            _loc8_ = var_87.roomSession.arePetsAllowed;
            _loc9_ = var_87.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
