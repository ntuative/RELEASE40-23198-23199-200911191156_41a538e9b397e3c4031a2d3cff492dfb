package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsView implements IInventoryView
   {
      ...
      private var var_531:ThumbListManager;
      
      private var var_530:ThumbListManager;
      ...
      public function EffectsView(param1:EffectsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IThumbListDataProvider, param6:IThumbListDataProvider)
      {
         ...
         var_530 = new ThumbListManager(_assetLibrary,param5,"thumb_bg_png","thumb_bg_selected_png",getActiveThumbListImageWidth(),getActiveThumbListImageHeight());
         var_531 = new ThumbListManager(_assetLibrary,param6,"thumb_bg_png","thumb_bg_selected_png",getActiveThumbListImageWidth(),getActiveThumbListImageHeight());
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = var_87.getSelectedEffect(0);
               if(_loc3_ != null)
               {
                  var_87.requestEffectActivated(_loc3_.type);
               }
            }
         }
      }
      ...
      private function activeThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc4_ = var_530.resolveIndexFromImageLocation(_loc3_);
            _loc5_ = var_87.getItemInIndex(_loc4_,1);
            if(_loc5_ != null)
            {
               var_87.toggleEffectSelected(_loc5_.type);
            }
         }
      }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:Effect = var_87.getSelectedEffect(-1);
         if(_loc3_ == null)
         {
            _loc1_.disable();
      ...
      public function updateListViews() : void
      {
         ...
         var _loc4_:BitmapData = var_530.getListImage();
      ...
      private function inactiveThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = new Point(WindowMouseEvent(param1).localX,WindowMouseEvent(param1).localY);
            _loc4_ = var_531.resolveIndexFromImageLocation(_loc3_);
            _loc5_ = var_87.getItemInIndex(_loc4_,0);
            if(_loc5_ != null)
            {
               var_87.toggleEffectSelected(_loc5_.type);
            }
