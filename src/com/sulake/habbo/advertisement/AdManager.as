package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1771:BitmapData = null;
      ...
      private var var_1772:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_436,0,0,_loc4_,var_1368,var_1772,var_1771));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var_1768 = int(_config.getKey("interstitial.show.time","5000"));
         var_1367 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1128 = _loc2_.imageUrl;
         var_1368 = _loc2_.clickUrl;
         if(var_1128 != "" && var_1368 != "")
         {
            _loc3_ = var_1128;
            ...
            _loc4_ = new URLRequest(var_1128);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_465,0,0,param1.bitmapData,var_1770));
            var_624 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1771 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1367 > 0 && var_1366 >= var_1367)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_624;
         if(_loc1_ > var_1769)
         {
            ++var_1366;
      ...
      {
         var_620 = param2 as IHabboCommunicationManager;
         if(var_620 == null)
         {
            return;
         }
         _connection = var_620.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_455));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1772 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
