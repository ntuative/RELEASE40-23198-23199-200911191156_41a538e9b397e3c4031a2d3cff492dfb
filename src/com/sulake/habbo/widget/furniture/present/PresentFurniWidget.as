package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_351,onObjectUpdate);
      ...
      private function method_1(param1:BitmapData) : void
      {
         if(param1 == null)
         {
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_351,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_420:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_351:
               if(!var_234)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_71:
               ...
               var_204 = param1.text;
               showInterface();
               method_1(param1.iconBitmapData);
               break;
         }
      }
      ...
      {
         var _loc1_:* = null;
         if(var_234 || var_161 == -1 || !_controller)
         {
            return;
         }
         var_234 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_516,var_161);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_53,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_992,const_991,2,2),null,0) as IWindowContainer;
