package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_406.destroyGridItems();
         var_282 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1262) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_841.width,var_841.height,true,0);
      ...
      {
         var _loc2_:int = var_406.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_406.numGridItems)
         {
            return;
         }
         select(var_406.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_841 = BitmapData(_loc3_.content);
