package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_311:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_53,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_992,const_991,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            var_311 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_311 != null)
         {
            var_311.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_877 = _loc2_.light;
         if(var_311 != null)
         {
            var_311.setValue(var_877);
         }
         var_402 = colors.indexOf(_loc2_.color);
         if(var_419 != null)
         {
            var_419.setSelectedColorIndex(var_402);
         }
