package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_592:Array = null;
      ...
      private var var_916:Array = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_109,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_304,update);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1825;
         if(_loc2_ > var_1204)
         {
            vote();
            return;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_109,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_304,update);
      }
