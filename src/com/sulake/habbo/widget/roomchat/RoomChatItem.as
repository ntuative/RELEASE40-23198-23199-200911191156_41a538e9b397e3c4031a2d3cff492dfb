package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1362:Number = 10;
      
      private static const const_1361:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_987,var_986,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_987,var_986,_roomId,_roomCategory,param1);
      }
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_988 != 0)
            {
               _loc31_ = uint(var_988 >> 16 & 255);
               _loc32_ = uint(var_988 >> 8 & 255);
               _loc33_ = uint(var_988 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1219 == RoomWidgetChatUpdateEvent.const_217)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_806);
            }
            else if(var_1219 == RoomWidgetChatUpdateEvent.const_249)
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_337 + _loc20_.textWidth + const_485;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_987,var_986,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_987,var_986,_roomId,_roomCategory,param1);
      }
