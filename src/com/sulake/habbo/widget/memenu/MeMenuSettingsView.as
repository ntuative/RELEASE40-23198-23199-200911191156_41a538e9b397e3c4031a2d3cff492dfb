package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_633:MeMenuSettingsViewSlider;
      
      private var var_1382:BitmapData;
      
      private var var_1380:BitmapData;
      
      private var var_632:Number = 1;
      ...
      {
         var_632 = param1.volume;
         if(var_633 != null)
         {
            var_633.setValue(var_632);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_633 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_646));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_632 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1381);
               }
               break;
            case "sounds_on":
               if(var_632 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1380);
               }
         }
      }
