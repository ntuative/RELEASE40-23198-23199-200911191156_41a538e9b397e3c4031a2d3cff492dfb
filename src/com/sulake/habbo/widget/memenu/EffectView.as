package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_721:IWindow;
      
      private var var_720:IWindow;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_720 = _window.findChildByName("effect_hilite");
            var_720.visible = false;
         }
         var_719 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_721 = _window.findChildByName("loader_bar");
         if(var_721 != null)
         {
            var_393 = var_721.width;
            var_166.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_719 != null)
         {
            var_719.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_719.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
