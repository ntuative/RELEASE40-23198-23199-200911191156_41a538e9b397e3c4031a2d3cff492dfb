package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_354:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_354 = new Sprite();
            var_354.addChild(new Bitmap(_image));
            var_354.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_354.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_354);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1304 != "")
         {
            HabboWebTools.openWebPage(var_1304);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_354 != null)
         {
            var_354.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_354 = null;
         }
         if(_image != null)
         {
