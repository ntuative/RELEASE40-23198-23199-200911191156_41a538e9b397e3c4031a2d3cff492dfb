package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         populate(_items,var_1459);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_668)
         {
            return;
         }
         if(var_668 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_668) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_668 % 2) ? uint(const_1364) : uint(const_1365);
            }
         }
