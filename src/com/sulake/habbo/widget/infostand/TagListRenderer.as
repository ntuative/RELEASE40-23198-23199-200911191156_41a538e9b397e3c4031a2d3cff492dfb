package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1540:int = 5;
      
      private const const_1541:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1054 != null && var_1054.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_702 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_702 += param1.height + const_1541;
            return fit(param1);
         }
         param1.offset(_offsetX,var_702);
         _offsetX += param1.width + const_1540;
         return true;
      }
