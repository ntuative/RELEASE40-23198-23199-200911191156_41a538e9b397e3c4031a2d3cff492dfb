package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1550:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1548:String = "level";
      
      private var var_105:IItemListWindow;
      
      private const const_1547:String = "energy";
      
      private var var_1135:Map;
      
      private const const_1549:String = "nutrition";
      
      private var var_64:IItemListWindow;
      
      private const const_1551:uint = 3355443;
      
      private var var_222:IBorderWindow;
      
      private const const_1545:int = 158;
      
      private const const_1546:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_248:PetCommandTool;
      
      private const const_1552:uint = 11184810;
      
      private const const_1553:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_222 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_222 != null)
         {
            var_105 = var_222.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_222.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_222.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_105 == null || var_222 == null || var_64 == null)
         {
            return;
         }
         ...
         var_222.height = NaN;
         _window.width = Math.max(var_222.width,var_64.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1135.getValue(var_718) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1548,param1.level,param1.levelMax);
         updateStateElement(const_1553,param1.experience,param1.experienceMax);
         updateStateElement(const_1547,param1.energy,param1.energyMax);
         updateStateElement(const_1549,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_718 = param1.id;
         var_1135.remove(param1.id);
         var_1135.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_454,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1545,const_1546,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1552);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1551);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1550);
         return _loc5_;
      }
