package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onRoomSettingsSaved(param1:IMessageEvent) : void
      {
         ...
         _navigator.mainViewCtrl.reloadRoomList(Tabs.const_194);
      }
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         {
            case CantConnectMessageParser.const_1210:
            ...
            case CantConnectMessageParser.const_1327:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_320:
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         Logger.log("Got subscription info: " + _loc2_.productName + ", " + _loc2_.daysToPeriodEnd + ", " + _loc2_.memberPeriods + ", " + _loc2_.periodsSubscribedAhead + ", " + _loc2_.method_4);
