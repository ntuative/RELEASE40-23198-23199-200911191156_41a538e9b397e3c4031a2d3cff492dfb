package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_674.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_828.getText());
         addTag(_loc6_,var_829.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_2042.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_674.setText(param1.eventDescription);
         var_828.setText(getTagFromEvent(param1,1));
         var_829.setText(getTagFromEvent(param1,2));
         var_1247.visible = false;
         var_1245.visible = true;
         var_1246.visible = true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1473 = IWindowContainer(find("event_type_disabled_cont"));
            var_2042 = ITextWindow(find("event_type_disabled_text"));
            var_1474 = ITextWindow(find("create_caption"));
            var_1475 = ITextWindow(find("edit_caption"));
            var_1247 = IButtonWindow(find("create_button"));
            var_1245 = IButtonWindow(find("edit_button"));
            var_2043 = IButtonWindow(find("cancel_button"));
            var_1246 = IButtonWindow(find("end_button"));
            var_827 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1247,onCreateButtonClick);
            Util.setProcDirectly(var_1245,onEditButtonClick);
            Util.setProcDirectly(var_1246,onEndButtonClick);
            Util.setProcDirectly(var_2043,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_674 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_828 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_829 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_674.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
