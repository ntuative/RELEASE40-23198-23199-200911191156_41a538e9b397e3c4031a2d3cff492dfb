package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2223:Dictionary;
      ...
      private var var_1656:ISessionDataManager;
      
      private var var_1655:RoomCreateViewCtrl;
      
      private var var_1654:RoomThumbnailRenderer;
      
      private var var_199:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1086:RoomInfoViewCtrl;
      ...
      private var var_949:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1086 = new RoomInfoViewCtrl(this);
         var_1655 = new RoomCreateViewCtrl(this);
         var_1654 = new RoomThumbnailRenderer(this);
         var_949 = new GuestRoomPasswordInput(this);
         var_309 = new GuestRoomDoorbell(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_428.startSearch(Tabs.const_192,Tabs.const_314,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_199 != null)
         {
            var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1656 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_428.startSearch(Tabs.const_239,Tabs.const_194);
         var_405.getTab(Tabs.const_239).tabPageDecorator.tabSelected();
      }
