package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1324:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_192,Tabs.const_197,"-1",MainViewCtrl.const_650);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1324 == null)
         {
            ...
            var_1324 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1324.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
