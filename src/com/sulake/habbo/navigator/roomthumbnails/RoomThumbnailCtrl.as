package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_87:ThumbnailEditorModel;
      ...
      public function RoomThumbnailCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_87 = new ThumbnailEditorModel();
      }
      
      private function refreshTab() : void
      {
         setEnabled(_bgTabButton,this.var_87.mode != ThumbnailEditorModel.const_35);
         setEnabled(var_1331,this.var_87.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1330,this.var_87.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_87.mode = ThumbnailEditorModel.const_35;
         this.reload();
      }
      ...
      {
         this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(_window.findChildByName("picframe")),var_87.data,false);
      }
      ...
      public function set active(param1:Boolean) : void
      {
         ...
         if(_active)
         {
            var_87.data = _navigator.data.enteredGuestRoom.thumbnail.getCopy();
         }
      }
      ...
      private function onSaveButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in var_87.data.objects)
         {
            if(_loc4_.imgId > 0)
            {
               _loc3_.push(_loc4_);
         ...
         _loc5_ = new UpdateRoomThumbnailMessageComposer(_navigator.data.enteredGuestRoom.flatId,var_87.data.bgImgId,var_87.data.frontImgId,_loc3_.length);
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_87.mode = ThumbnailEditorModel.const_51;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1331 = IButtonWindow(find("top_tab"));
         var_1330 = IButtonWindow(find("obj_tab"));
         var_1666 = IWindowContainer(find("tile_grid"));
         var_1667 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1331,onTopTabButton);
         Util.setProcDirectly(var_1330,onObjTabButton);
      }
      ...
      private function refreshImgSelector(param1:int) : void
      {
         ...
         var _loc5_:int = var_87.getImgId();
         var _loc6_:int = 0;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1666;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_380)
            {
         ...
         _loc2_.visible = true;
         refreshTileLoc(_loc2_,var_87.selected.pos);
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_87.mode = ThumbnailEditorModel.const_31;
         this.reload();
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = var_1667;
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Dictionary = var_87.getBlockedPositions();
         while(_loc3_ <= RoomThumbnailRenderer.const_380)
         {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_53,HabboWindowStyle.const_38,HabboWindowParam.const_65,new Rectangle(0,0,param1.width,66)));
