package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1654 = new RoomThumbnailRenderer(param1);
         var_944 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_176,var_119.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_944.refreshTags(_loc1_,var_119.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1654.refreshThumbnail(_loc1_,var_119.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_176,var_119);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_176,!true ? getEventCtg(var_119.categoryId) : getRoomCtg(var_119.categoryId));
         refreshRoomDesc(var_176,var_119);
         refreshExtraCont();
         refreshInfo(var_176,"trading_allowed",var_119.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_192,Tabs.const_197,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
