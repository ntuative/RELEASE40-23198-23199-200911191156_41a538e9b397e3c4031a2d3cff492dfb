package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1350:CutToHeight = new CutToHeight();
      
      private static var var_1351:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1350.beforeSearch(param2,param1,param3);
         binarySearch(var_1350,param2.length - 1);
      }
